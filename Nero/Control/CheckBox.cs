...
namespace Nero.Control
{
    ...
    public class CheckBox : Control
    {
        ...
        public override void Draw(RenderTarget target, RenderStates states)
        {
            ...
            {
                // Box
                DrawRectangle(target, gp, new Vector2(14, 14), new Color(10, 10, 10), 1, new Color(200, 200, 200));
                DrawShadowRectangle(target, gp - new Vector2(1, 1), new Vector2(16, 16), Border_Opacity, Border_Scale);

                // Valor
                if (_checked)
                    DrawRectangle(target, gp + new Vector2(1, 1), new Vector2(12, 12), new Color(200, 200, 200));
